...
from apps.models import RequestLog, FundFlow
...
def service_statistic():
    ...
    try:
        ...
        if input_json and date_start and date_end:
            ...
            search_res =  sql_res.group_by(RequestLog.path)

        search_res = search_res.dicts()
        res_list = []
        ...
        logging.info("get service_statistic error. %s", e)
        res.Code = 500
